...
{
	public function new(xPos:Float, yPos:Float, looped:Bool = false, glow:Bool = false, fps:Int = 24, frameOffset:Int = 0, maxFrames:Int = 0,
			flippedX:Bool = false, flippedY:Bool = false)
	{
		super(xPos, yPos);
