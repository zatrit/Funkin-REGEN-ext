...
class MobileControls extends FlxTypedGroup<FlxSprite>
{
	...
	{
		var upArrow:MobileButton = new MobileButton(x + 160, y, "Up", false, () -> {}, () -> {});
		upArrow.updateHitbox();
		upArrow.cameras = [camHUD];

		var downArrow:MobileButton = new MobileButton(x + 160, y + 210, "Down", false, () -> {}, () -> {});
		downArrow.updateHitbox();
		downArrow.cameras = [camHUD];

		var leftArrow:MobileButton = new MobileButton(x, y + 100, "Left", false, () -> {}, () -> {});
		leftArrow.updateHitbox();
		leftArrow.cameras = [camHUD];

		var rightArrow:MobileButton = new MobileButton(x + 320, y + 100, "Right", false, () -> {}, () -> {});
